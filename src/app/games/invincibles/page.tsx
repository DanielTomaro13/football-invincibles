  ...
  return (
    <GameShell
      ...
      howTo={[
        ...
        "Each spin gives you a random club from a random season. Tap a player to see their stats, then add them to a position they can play.",
        "Positions matter — a striker can't fill a defender's slot. Versatile players (★) can fill more than one position and get up to a 1.15× boost; playing out of position costs rating.",
        "Use the GK / DEF / MID / FWD filters to find what you still need. You get 3 club and 3 year re-spins per attempt.",
