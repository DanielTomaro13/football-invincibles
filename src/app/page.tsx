...
export const metadata: Metadata = pageMeta({
  title: "Football Invincibles — Stats, Tables & Football Mini-Games",
  description:
    "Live Premier League tables and stats plus a vault of football mini-games: Footle, Higher or Lower, Guess the Player, Career Path and the Invincibles squad-builder. More competitions coming soon.",
  path: "/",
  keywords: [
    "football games",
...
export default async function Home() {
  ...
  return (
    <div style={{ display: "grid", gap: "2.5rem" }}>
      ...
      <section
        className="card"
        style={{ padding: "2.5rem 1.5rem", textAlign: "center", overflow: "hidden" }}
      >
        <span className="chip" style={{ marginBottom: 14 }}>
          ⚽ Premier League live · more leagues soon
        </span>
        ...
        <p style={{ color: "var(--muted)", maxWidth: 620, margin: "0 auto 1.4rem", fontSize: "1.05rem" }}>
          Live tables and stats, deep player profiles, and a growing collection of
          addictive football mini-games — all in one place.
        </p>
